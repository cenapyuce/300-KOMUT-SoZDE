...
client.on('guildCreate', guild => {
  ...
  .addField('**Dinle Ve Eğlen Bot sunucunuza eklendi!**', `${owner}`)
  .addField('**Dinle Ve Eğlen Bot** sunucunuzdaki insanlara kolaylıklar sağlar.', `**${prefix}bilgi** yazmanız yeterlidir!`)
